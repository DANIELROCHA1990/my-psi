...
import { User, Lock, Mail, Phone, MapPin, DollarSign, Save, Eye, EyeOff, Link2, FileText } from 'lucide-react'
...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    if (tabParam && ['profile', 'security', 'integrations', 'documents'].includes(tabParam)) {
