...
function SessionModal({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.patient_id || !formData.session_date) {
      toast.error('Paciente e data sao obrigatorios')
      return
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  placeholder={selectedPatient ? `Valor padrao: R$ ${selectedPatient.session_price?.toLocaleString('pt-BR', { minimumFractionDigits: 2 }) || '0,00'}` : 'Digite o valor'}
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  placeholder="Observacoes e anotacoes importantes..."
                />
              </div>
